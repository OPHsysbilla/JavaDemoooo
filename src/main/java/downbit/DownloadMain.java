...
import downbit.util.HttpUtls;
import downbit.util.LogUtils;
...
public class DownloadMain {
    ...
    public void download(String url) throws Exception {
        ...
        // 任务切分
        long sizeEachPart = httpFileContentLength / DOWNLOAD_THREAD_NUM;
//        long lastSize = httpFileContentLength - (httpFileContentLength / DOWNLOAD_THREAD_NUM * (DOWNLOAD_THREAD_NUM
        long lastPartSize = httpFileContentLength % DOWNLOAD_THREAD_NUM;
        for (int i = 0; i < DOWNLOAD_THREAD_NUM; i++) {
            // [start_1, end_1], [end_1 + 1, end_2] ... [end_n-1 + 1, end_n]
            // where end_n = end_n-1 + 1 + lastPartSize
            // and end_1 = start_1 + 1 + sizeEachPart
            long start = i * sizeEachPart;
            Long downloadWindow = (i == DOWNLOAD_THREAD_NUM - 1) ? lastPartSize : sizeEachPart;
